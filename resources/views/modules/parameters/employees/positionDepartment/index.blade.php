...
@section('content')
	@component('componentes.card', [
        'shadow' => true,
        'title' => 'Departamentos',
        'breadcrumb' => 'parameters/employees/departments'])
        ...
        <div class="collapse card-body" id="buscar">
            <form
                method="GET"
                id="formSearch"
                action="{{ route('params.employees.departments.search') }}">
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline frmDestroy"
                                        action="{{ route('params.employees.departments.destroy', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.employees.departments.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.employees.departments.store') }}"
        method="POST"
        id="formStore">
        @csrf
