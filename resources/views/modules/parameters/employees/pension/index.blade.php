...
@section('content')
	@component('componentes.card', [
        'shadow' => true,
        'title' => 'Pensiones',
        'breadcrumb' => 'parameters/employees/pensions'])
        ...
        <div class="collapse card-border" id="buscar">
            <form
                method="GET"
                id="formSearch"
                action="{{ route('params.employees.pensions.search') }}">
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline frmDestroy"
                                        action="{{ route('params.employees.pensions.destroy', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.employees.pensions.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.employees.pensions.store') }}"
        method="POST"
        id="formStore">
        @csrf
