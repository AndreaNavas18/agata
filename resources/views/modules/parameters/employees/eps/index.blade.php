...
@section('content')
	@component('componentes.card', [
        'shadow' => true,
        'title' => 'EPS',
        'breadcrumb' => 'parameters/employees/eps'])
        ...
        <div class="collapse card-border" id="buscar">
            <form
                method="GET"
                id="formSearch"
                action="{{ route('params.employees.eps.search') }}">
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline frmDestroy"
                                        action="{{ route('params.employees.eps.destroy', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.employees.eps.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.employees.eps.store') }}"
        method="POST"
        id="formStore">
        @csrf
        @component('componentes.modal', [
