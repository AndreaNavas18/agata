...
@section('content')
	@component('componentes.card', [
        'shadow' => true,
        'title' => 'Cesantias',
        'breadcrumb' => 'parameters/employees/severance'])
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline frmDestroy"
                                        action="{{ route('params.employees.severance.destroy', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.employees.severance.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.employees.severance.store') }}"
        method="POST"
        id="formStore">
        @csrf
