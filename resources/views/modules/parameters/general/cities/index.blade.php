...
@section('content')
	@component('componentes.card', [
        'shadow' => true,
        'title' => 'Ciudades',
        'breadcrumb' => 'parameters/general/cities'])
        ...
        <div class="collapse card-border" id="buscar">
            <form
                method="GET"
                id="formSearch"
                action="{{ route('params.general.cities.search') }}">
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline frmDestroy"
                                        action="{{ route('params.general.cities.destroy', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.general.cities.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.general.cities.store') }}"
        method="POST"
        id="formStore">
        @csrf
