...
@section('content')
	@component('componentes.card', [
        'shadow' => true,
        'title' => 'Paises',
        'breadcrumb' => 'parameters/general/countries'])
        ...
        <div class="collapse card-border" id="buscar">
            <form method="GET"
                id="formSearch"
                action="{{ route('params.general.countries.search') }}">
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline frmDestroy"
                                        action="{{ route('params.general.countries.destroy', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.general.countries.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.general.countries.store') }}"
        method="POST"
        id="formStore">
        @csrf
