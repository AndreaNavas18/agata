@extends('layouts.app')
@section('title', 'Proyectos - Contratos - Subclientes Stratecsa')
@push('script')
	<script>
...
@section('content')
	@component('componentes.card', [
        'shadow' => true,
        'title' => 'Proyectos - Contratos - Subclientes',
        'breadcrumb' => 'parameters/general/proyectos'])
        ...
        <div class="collapse card-border" id="buscar">
            <form method="GET"
                id="formSearch"
                action="{{ route('params.general.proyectos.search') }}">
                <div class="row">
                        ...
                        @foreach($datos as $key=> $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.general.proyectos.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.general.proyectos.store') }}"
        method="POST"
        id="formStore">
        @csrf
        ...
        @component('componentes.modal', [
            'id' => 'modalCrear',
            'title' => 'Nuevo proyecto - contrato - subcliente',
            'btnCancel' => true])
            @slot('body')
                <div class="form-group">
