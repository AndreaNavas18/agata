...
@section('content')
	@component('componentes.card', [
        ...
        'breadcrumb' => 'parameters/general/types_contact'])
        ...
        <div class="collapse card-border" id="buscar">
            <form  method="GET"
            id="formSearch"
            action="{{ route('params.general.types_contact.search') }}">
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="d-inline frmDestroy"
                                        action="{{ route('params.general.types_contact.destroy', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    {{-- editar --}}
                                    <form action="{{ route('params.general.types_contact.update', $row->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
	...
	<!-- Modal -->
    <form action="{{ route('params.general.types_contact.store') }}"
        method="POST"
        id="formStore">
        @csrf
