...
class GeneralTypeDocumentController extends Controller
{
    /**
    ...
    {
        $datos = TypeDocument::orderBy('name')->paginate();
        return view('modules.parameters.general.typeDocuments.index', compact('datos'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $typeDocumentNew = TypeDocument::where('name', $name)->first();
    ...
    public function destroy($id)
    {
        try {
            DB::beginTransaction();
            if (!TypeDocument::findOrFail($id)->delete()) {
    ...
    {
        $datos = TypeDocument::name($request->input('name'))->orderBy('name')->paginate();
        $data = $request->all();
        return view('modules.parameters.general.typeDocuments.index', compact('datos','data'));
    }
