<div class="row">
    ...
    <template id="service-template">
        <div class="service-group">
            ...
            <div id="velocidades-container" id="velocidades-container-template">
                {{-- @php
                    dd($bandwidths);
                @endphp --}}
            ...
            <div class="col-md-12 mb-3">
                <button type="button" id="add-velocidad" class="btn btn-primary add-velocidad">Añadir velocidad (Mbps)</button>
            </div>
            @include('modules.commercial.quotes.partials.velocidad')
    

            <div id="tramos-container" id="tramos-container-template">
